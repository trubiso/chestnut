...
OBJS = diagnostic.o levenshtein.o lexer.o main.o out_fmt.o parser.o resolver.o resolver_identify.o resolver_symbols.o resolver_types.o token.o ast/expression.o ast/function.o ast/identifier.o ast/module.o ast/statement.o ast/tag.o ast/type.o
