...
private:
	...
	void identify(Spanned<AST::Name>&, decltype(Symbol::item), bool exported, TypeVar, FileContext::ID, bool mutable_ = false);
	/// Identifies all variable declarations.
	void identify(AST::Statement&, FileContext::ID);
